...
<body class="bg-theme <?php echo $color_manager ?>">
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Configuración del titulo</div>
					<div class="ps-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="row">
											...
											<div class="col-sm-9">
												<center><h5 class="mb-3">Titulo del sistema</h5></center>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="titulo" value="<?php echo $titulo; ?>" placeholder="Ingresa el nombre del titulo del sistema" />
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-sm-9 d-grid gap-2">
												<button type="button" class="btn btn-light px-4 btn-block" id="configuracion-titulo">Actualizar información</button>
											</div>
										</div>
	...
	<script src="validaciones/configuracion/js/configuracion-titulo.js"></script>
