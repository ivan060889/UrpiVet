...
<body class="bg-theme <?php echo $color_manager ?>">
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Configuración del logo</div>
					<div class="ps-3">
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="d-flex flex-column align-items-center text-center">
											<img src="../assets/img/logo/<?php echo $logo ?>" alt="Admin" class="rounded-circle p-1 " width="190" height="190">
										</div>
										<hr class="my-3" />
									</div>
								</div>
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-12">
												<center><h5 class="mb-3">Logo del sistema</h5></center>
											</div>
										</div>
										<div class="row mb-3">
											<center>
												...
												<small class="color_blanco">Sube aqui el nuevo logo</small>
											</center>
										...
										<div class="row">
											<div class="col-sm-12 d-grid gap-2">
												<button type="button" class="btn btn-light px-4 btn-block" id="logo-editar">Actualizar información</button>
											</div>
										</div>
	...
	<script src="validaciones/configuracion/js/configuracion-logo.js"></script>
