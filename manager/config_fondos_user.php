...
<body class="bg-theme <?php echo $color_manager ?>">
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-12">
												<center><h5 class="mb-3">ACTUALIZAR FONDO DEL PANEL USUARIO</h5></center>
											</div>
										</div>
										<div class="row mb-3">
											<center>
												...
												<small class="color_blanco">Sube aqui el nuevo fondo del panel usuario<br>La imagen debe ser de 1920x1080</small>
											</center>
										...
										<div class="row">
											<div class="col-sm-12 d-grid gap-2">
												<button type="button" class="btn btn-light px-4 btn-block" id="fondos-user">Actualizar información</button>
											</div>
										</div>
	...
	<script src="validaciones/configuracion/js/configuracion-fondos-user.js"></script>
