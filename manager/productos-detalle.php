...
<head>
	<base href="<?php echo $dominio ?>/manager/productos-detalle.php" />
	<meta charset="utf-8">
...
<?php
require("../conexion/conexion.php");
$configuracion="SELECT fondo_manager FROM configuracion ";
$config=mysqli_query($mysqli,$configuracion);
while ($conf=mysqli_fetch_row ($config)){
	$fondo_manager=$conf[0];
}
?>

<body class="bg-theme <?php echo $fondo_manager ?>">
		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item" aria-current="page"><a href="productos">Lista de productos</a></li>
				...
				if($id_product==true){
					...
					$inventarios="SELECT * FROM productos WHERE id_producto='$id_product'";
