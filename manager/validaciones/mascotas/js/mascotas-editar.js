$('#mascotas-detalle').click(function() {
  ...
  if (nombre == '') {
    ...
    $.ajax({
      type: 'POST',
      url: 'validaciones/mascotas/mascotas-editar',
      data: {id_mascota: id_mascota, nombre: nombre, fecha_nacimiento: fecha_nacimiento, edad: edad, raza: raza, especie: especie, color: color, sexo: sexo, peso: peso, tipo_peso: tipo_peso},
