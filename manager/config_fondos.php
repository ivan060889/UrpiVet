								...
								<div class="card">
									<div class="card-body">
										...
										<div class="d-flex flex-column align-items-center text-center">
											<h5>FONDO DEL PANEL DE LOGIN</h5>
											<img src="../assets/images/bg-themes/<?php echo $color ?>.png" alt="Admin" width="250" height="150">
											<br>
											<a href="config_fondos_login"><button type="button" class="btn btn-light px-4">NUEVO FONDO</button></a>
										</div>
										<hr class="my-3" />
									</div>
								</div>
							...
							<div class="col-lg-4">
								<div class="card">
									<div class="card-body">
										<hr class="my-3" />
										<div class="d-flex flex-column align-items-center text-center">
											<h5>FONDO DEL PANEL ADMINISTRADOR</h5>
											<img src="../assets/images/bg-themes/<?php echo $color_admin ?>.png" alt="Admin" width="250" height="150">
											<br>
											<a href="config_fondos_admin"><button type="button" class="btn btn-light px-4">NUEVO FONDO</button></a>
										</div>
										<hr class="my-3" />
									</div>
								</div>
							...
							<div class="col-lg-4">
								<div class="card">
									<div class="card-body">
										<hr class="my-3" />
										<div class="d-flex flex-column align-items-center text-center">
											<h5>FONDO DEL PANEL USUARIO</h5>
											<img src="../assets/images/bg-themes/<?php echo $color_user ?>.png" alt="Admin" width="250" height="150">
											<br>
											<a href="config_fondos_user"><button type="button" class="btn btn-light px-4">NUEVO FONDO</button></a>
										</div>
										<hr class="my-3" />
									</div>
								</div>
