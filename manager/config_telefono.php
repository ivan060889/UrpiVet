...
<body class="bg-theme <?php echo $color_manager ?>">
								...
								<div class="card">
									<div class="card-body">
										<div class="row">
											...
											<div class="col-sm-9">
												<center><h5 class="mb-3">Whatsapp del sistema</h5></center>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="telefono" value="<?php echo $telefono; ?>" placeholder="Ingresa el numero de telefono" />
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-sm-9 d-grid gap-2">
												<button type="button" class="btn btn-light px-4 btn-block" id="configuracion-telefono">Actualizar información</button>
											</div>
										</div>
	...
	<script src="validaciones/configuracion/js/configuracion-telefono.js"></script>
