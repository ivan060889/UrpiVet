...
<head>
	<base href="<?php echo $dominio ?>/user/internamientos-detalle.php" />
	<meta charset="utf-8">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item" aria-current="page"><a href="mascotas">Mis Mascotas</a></li>
				...
				if($id_pet==true){
					...
					if ($result > 0) {
						while ($pets=mysqli_fetch_row ($mascota)){
							...
							$internamientos="SELECT * FROM internamientos WHERE id_internamiento='$id_internamiento' and id_mascota='$id_mascota' ";
							$internamiento=mysqli_query($mysqli,$internamientos);
							$result2 = 0;
							$result2 = mysqli_num_rows($internamiento);
							if ($result2 > 0) {
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="date" class="form-control" id="fecha_entrada" value="<?php echo $fecha_entrada_i; ?>" readonly/>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												<input type="date" class="form-control" id="fecha_salida" value="<?php echo $fecha_salida_i; ?>" readonly/>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												<textarea class="form-control" rows="3" id="medicinas_aplicadas" readonly><?php echo $medicinas_aplicadas_i; ?></textarea>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												<textarea class="form-control" rows="3" id="motivo" readonly><?php echo $motivo_i; ?></textarea>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												<textarea class="form-control" rows="3" id="antecedentes" readonly><?php echo $antecedentes_i; ?></textarea>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												<textarea class="form-control" rows="3" id="tratamiento" readonly><?php echo $tratamiento_i; ?></textarea>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9">
												...
												if($estado_i==0){
													...
													echo 
													'
													<button type="button" class="btn btn-success px-5" style="width:100%;">INTERNADO</button>
													';
													...
													echo 
													'
													<button type="button" class="btn btn-danger px-5" style="width:100%;">DADO DE ALTA</button>
													';
