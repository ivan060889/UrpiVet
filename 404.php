...
$configuracion="SELECT marca, logo, color, telefono FROM configuracion ";
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent1">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"> <a class="nav-link text-white" href="login"><i class='bx bx-user me-1'></i>Login</a>
						</li>
						<li class="nav-item"> <a class="nav-link text-white" href="register"><i class='bx bx-category-alt me-1'></i>Registro</a>
						</li>
					</ul>
				</div>
			</div>
						...
						<div class="col col-xl-6">
							<center>
								<div class="card-body p-4">
									...
									<div class="mt-5"> <a href="index" class="btn btn-light btn-lg px-md-5 radius-30">INICIO</a>
										<a href="login" class="btn btn-light btn-lg ms-3 px-md-5 radius-30">LOGIN</a>
									</div>
								</div>
							</center>
						</div>
